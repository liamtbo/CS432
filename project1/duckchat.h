...
struct text_list {
        ...
        int txt_nchannels;
        // struct channel_info txt_channels[32]; // May actually be more than 0
        char txt_channels[32]; // May actually be more than 0
...
struct text_who {
        ...
        int txt_nusernames;
        char us_username[USERNAME_MAX]; // May actually be more than 0
